...
export default function MicrogridPage() {
  ...
  return (
    <>
      ...
      />
      <Head>
        <title>주식회사 이에프디 | 마이크로그리드 에너지관리시스템</title>
      </Head>
      ...
      >
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          variants={itemVariants}
          className="text-center text-[2rem] leading-[110%]"
        >
          약어 정리
        </motion.h2>
        <motion.div
        ...
        >
          <div className="flex flex-col gap-4">
            <motion.h2
              variants={itemVariants}
              className="mb-2 text-[2rem] leading-[110%] font-bold"
            >
              납품실적
            </motion.h2>
            <motion.p variants={itemVariants}>
              다양한 납품실적을 통한 효성중공업의 노하우가 있습니다.
            </motion.p>
          </div>
        </motion.div>
        <motion.div
          ...
          viewport={{ once: true }}
          variants={sectionVarients}
          className="mt-[-70px] flex flex-col items-center gap-17 md:flex-row"
        >
